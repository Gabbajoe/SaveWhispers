...
- Ask before implementing on ambiguous/large features (the user has explicitly pushed back on agents jumping straight to code); small, unambiguous bug fixes can be done directly.
